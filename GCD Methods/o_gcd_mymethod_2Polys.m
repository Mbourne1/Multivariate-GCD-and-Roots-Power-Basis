...
t_new = GetGCDDegree_Total_WithLimits_2Polys(fww,alpha.*gww,m,n,limits_t);
...
switch SETTINGS.DEGREE_METHOD
    case 'Total'
        ...
        [t] = GetGCDDegree_Total_WithLimits_2Polys(fww,alpha.*gww,m,n,limits_t);
        t1 = 1000;
        t2 = 1000;
    ...
    case 'Relative'
        ...
        t = 1000;
        [t1,t2] = GetGCDDegree_Relative_2Polys(fww,alpha.*gww);
    ...
    case 'Both'
        ...
        [t1,t2] = GetGCDDegree_Relative_Given_t_2Polys(fww,alpha*gww,m,n,t);
...
[fxy_lr, gxy_lr, uxy_lr, vxy_lr, alpha_lr, th1_lr, th2_lr] = LowRankApprox_2Polys(fxy_n, gxy_n, alpha, th1, th2, m, n, t, t1, t2, idx_col);



[fxy_lra, gxy_lra, uxy_lra, vxy_lra, dxy_lra, alpha_lra, th1_lra, th2_lra] = ...
    APF_2Polys(fxy_lr, gxy_lr, uxy_lr, vxy_lr, m, n, t, alpha_lr, th1_lr, th2_lr);
