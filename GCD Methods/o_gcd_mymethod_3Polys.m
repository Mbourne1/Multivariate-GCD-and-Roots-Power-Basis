...
t_new = GetGCDDegree_Total_WithLimits_3Polys(fww, alpha.*gww, hww, m, n, o, limits_t);
...
switch SETTINGS.DEGREE_METHOD
    case 'Total'
        ...
        [t] = GetGCDDegree_Total_WithLimits_3Polys(fww, alpha.*gww, hww, ...
            m, n, o, limits_t);
        t1 = 1000;
        t2 = 1000;
    ...
    case 'Relative'
        ...
        t = 1000;
        [t1,t2] = GetGCDDegree_Relative_3Polys(fww, alpha.*gww, hww);
    ...
    case 'Both'
        ...
        [t1,t2] = GetGCDDegree_Relative_Given_t_3Polys(fww, alpha*gww, hww,...
            m, n, o, t);
...
[fxy_lr, gxy_lr, hxy_lr, uxy_lr, vxy_lr, wxy_lr, alpha_lr, th1_lr, th2_lr] = ...
    LowRankApprox_3Polys(fxy_n, gxy_n, hxy_n, alpha, th1, th2, m, n, o, t, t1, t2, idx_col);



[fxy_lra, gxy_lra, hxy_lra, uxy_lra, vxy_lra, wxy_lra, dxy_lra, alpha_lra, th1_lra, th2_lra] = ...
    APF_3Polys(fxy_lr, gxy_lr, hxy_lr, uxy_lr, vxy_lr, wxy_lr, m, n, o, t, alpha_lr, th1_lr, th2_lr);
