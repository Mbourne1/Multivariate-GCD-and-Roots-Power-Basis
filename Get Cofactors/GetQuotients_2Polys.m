function [uxy,vxy] =  GetQuotients_2Polys(fxy, gxy, m, n, t, t1, t2)
%
%
% % Inputs
%
...
switch SETTINGS.DEGREE_METHOD
    case 'Total'
        [uxy,vxy] = ...
            GetQuotients_Total_2Polys(fxy, gxy, m, n, t);
        
    case 'Relative'
        [uxy,vxy] = ...
            GetQuotients_Relative_2Polys(fxy, gxy, t1, t2);
        
    case 'Both'
        [uxy,vxy] = ...
            GetQuotients_Both_2Polys(fxy, gxy, m, n, t, t1, t2);
