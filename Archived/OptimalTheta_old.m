function [theta1,theta2] = OptimalTheta(fxy_mtrx, gxy_mtrx)
...
for i1 = 0:1:m1
    for i2 = 0:1:m2
        % Replace all of the 'count-th row'
        PartThree(count,:) = [0 -1 (m1-i1) (m2-i2) ];
        count = count + 1;
    end
end
...
for i1 = 0:1:n1
    for i2 = 0:1:n2
        % Replace all of the 'count-th row'
        PartFour(count,:) = [0 -1 (n1-i1) (n2-i2) ];
        count = count + 1;
    end
end
