function [t1,t2] = GetGCDDegree_Relative_Given_t_2Polys(fxy,gxy,m,n,t)
...
k1k2Pairs = GetPairs_All_2Polys(m1,m2,n1,n2);
...
for i = 1:1:nPairs
    ...
    Skk1k2 = BuildSylvesterMatrix_Both_2Polys(fxy, gxy, m, n, t, k1, k2);
