function [t] = GetGCDDegree_Total_WithLimits_3Polys(fxy,gxy, hxy, m, n, o, limits_t)
...
for k = lower_lim_comp:1:upper_lim_comp
    ...
    T2 = BuildT1_Total(fxy_matrix_padd,m,o-k);
    
    
    T3 = BuildT1_Total(gxy_matrix_padd,n,m-k);
    
    T4 = BuildT1_Total(hxy_matrix_padd,o,m-k);
