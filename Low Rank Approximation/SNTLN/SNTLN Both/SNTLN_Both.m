...
nCoeffs_fv = GetNumNonZeros(m1+n1-k1,m2+n2-k2,m+n-k);
...
% c_{t}.
nCoeffs_x = nNonZeros_uxy + nNonZeros_vxy - 1;
...
Tf = BuildT1_Both(fww,m,n-k,n1-k1,n2-k2);
Tg = BuildT1_Both(gww,n,m-k,m1-k1,m2-k2);
...
Tfww_wrt_alpha = BuildT1_Both(Partial_fww_wrt_alpha,m,n-k,n1-k1,n2-k2);
Tgww_wrt_alpha = BuildT1_Both(Partial_alpha_gww_wrt_alpha,n,m-k,m1-k1,m2-k2);
Tfg_alpha = [Tfww_wrt_alpha Tgww_wrt_alpha];

% %
% Calculate the derivative of T(f,g) with respect to theta_{1}
Tfww_wrt_th1 = BuildT1_Both(Partial_fww_wrt_th1,m,n-k,n1-k1,n2-k2);
Tgww_wrt_th1 = BuildT1_Both(Partial_gww_wrt_th1,n,m-k,m1-k1,m2-k2);
Partial_Tfg_wrt_th1 = [Tfww_wrt_th1 alpha(ite)* Tgww_wrt_th1];

% %
% Calcualte the derivative of T(f,g) with respect to theta_2
Tfww_wrt_th2 = BuildT1_Both(Partial_fww_wrt_th2,m,n-k,n1-k1,n2-k2);
Tgww_wrt_th2 = BuildT1_Both(Partial_gww_wrt_th2,n,m-k,m1-k1,m2-k2);
...
Partial_N_wrt_th1   = zeros(nRows_Sylv_mat,nCols_Tf + nCols_Tg);

% Initialise the derivative of N wrt theta 2
Partial_N_wrt_th2   = zeros(nRows_Sylv_mat,nCols_Tf + nCols_Tg);
...
while condition(ite) >(SETTINGS.MAX_ERROR_SNTLN) &&  ite < SETTINGS.MAX_ITERATIONS_SNTLN
    ...
    z_fxy = GetAsMatrix([z_fxy_vec ; zeros(nZeros_fxy,1)],m1,m2);
    z_gxy = GetAsMatrix([z_gxy_vec ; zeros(nZeros_gxy,1)],n1,n2);
    ...
    N1 = BuildT1_Both(z_fww, m, n-k, n1-k1, n2-k2);
    N2 = BuildT1_Both(z_gww, n, m-k, m1-k1, m2-k2);
    N = [N1 alpha(ite).*N2];
    
    % Build the coefficient matrix N with respect to alpha
    T_zf_wrt_alpha = BuildT1_Both(Partial_zfww_wrt_alpha,m,n-k,n1-k1,n2-k2);
    T_zg_wrt_alpha = BuildT1_Both(Partial_zgww_wrt_alpha,n,m-k,m1-k1,m2-k2);
    Partial_N_wrt_alpha = [T_zf_wrt_alpha T_zg_wrt_alpha];
    
    
    % Calculate the derivatives of DNQ with respect to theta
    T_zf_wrt_th1 = BuildT1_Both(Partial_zfww_wrt_th1,m,n-k,n1-k1,n2-k2);
    T_zg_wrt_th1 = BuildT1_Both(Partial_zgww_wrt_th1,n,m-k,m1-k1,m2-k2);
    Partial_N_wrt_th1 = [T_zf_wrt_th1 alpha(ite).*T_zg_wrt_th1];
    
    % Calculate the derivatives of DNQ with respect to theta
    T_zf_wrt_th2 = BuildT1_Both(Partial_zfww_wrt_th2,m,n-k,n1-k1,n2-k2);
    T_zg_wrt_th2 = BuildT1_Both(Partial_zgww_wrt_th2,n,m-k,m1-k1,m2-k2);
    ...
    TN_fww = BuildT1_Both(fww + z_fww, m, n-k, n1-k1, n2-k2);
    TN_gww = BuildT1_Both(gww + z_gww, n, m-k, m1-k1, m2-k2);
    TN = [TN_fww alpha(ite).*TN_gww];
    
    % Calculate the paritial derivative of (T+N) with respect to
    % \alpha
    TN1_wrt_alpha = BuildT1_Both(Partial_fww_wrt_alpha + Partial_zfww_wrt_alpha, m, n-k, n1-k1, n2-k2);
    TN2_wrt_alpha = BuildT1_Both(Partial_alpha_gww_wrt_alpha + Partial_zgww_wrt_alpha, n, m-k, m1-k1, m2-k2);
    TN_alpha = [TN1_wrt_alpha TN2_wrt_alpha];
    
    
    % Calculate the paritial derivative of (T+N) with respect to
    % \theta_{1}
    TN1_wrt_th1 = BuildT1_Both(Partial_fww_wrt_th1 + Partial_zfww_wrt_th1, m, n-k, n1-k1, n2-k2);
    TN2_wrt_th1 = BuildT1_Both(Partial_gww_wrt_th1 + Partial_zgww_wrt_th1, n, m-k, m1-k1, m2-k2);
    TN_th1 = [TN1_wrt_th1 alpha(ite).*TN2_wrt_th1];
    
    % Calculate the paritial derivative of (T+N) with respect to
    % \theta_{2}
    TN1_wrt_th2 = BuildT1_Both(Partial_fww_wrt_th2 + Partial_zfww_wrt_th2, m, n-k, n1-k1, n2-k2);
    TN2_wrt_th2 = BuildT1_Both(Partial_gww_wrt_th2 + Partial_zgww_wrt_th2, n, m-k, m1-k1, m2-k2);
...
vww = GetAsMatrix([vec_vww ; zeros(nZeros_vxy,1)],n1-k1,n2-k2);
uww = GetAsMatrix([vec_uww ; zeros(nZeros_uxy,1)],m1-k1,m2-k2);
