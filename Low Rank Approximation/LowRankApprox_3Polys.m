...
switch SETTINGS.LOW_RANK_APPROXIMATION_METHOD
    ...
    case 'None'
        ...
        [uww_lr, vww_lr, www_lr] = GetQuotients_3Polys(fww, a_gww, hww, m, n, o, k, k1, k2);
    ...
    otherwise
        ...
        S1 = BuildSylvesterMatrix_3Polys(fxy, gxy, hxy, m, n, o, k, k1, k2);
        
        % Build Sylvester matrix of low rank approx of input polys.
        S2 = BuildSylvesterMatrix_3Polys(fxy_lr, gxy_lr, hxy_lr, m, n, o, k, k1, k2);
        
        % Build Sylvester matrix of polys in preprocessed form
        S3 = BuildSylvesterMatrix_3Polys(fww, alpha.*gww, hww, m, n, o, k, k1, k2);
        
        % Build Sylvester matrix of polys in preprocessed form with pert.
        S4 = BuildSylvesterMatrix_3Polys(fww_lr, alpha.*gww_lr, hww_lr, m, n, o, k, k1, k2);
