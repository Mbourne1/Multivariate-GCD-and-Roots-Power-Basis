...
switch SETTINGS.LOW_RANK_APPROXIMATION_METHOD
    ...
    case 'None'
        ...
        [uww_lr,vww_lr] = GetQuotients_2Polys(fww, a_gww, m, n, k, k1, k2);
    ...
    otherwise
        ...
        S1 = BuildSylvesterMatrix_2Polys(fxy, gxy, m, n, k, k1, k2);
        
        % Build Sylvester matrix of low rank approx of input polys.
        S2 = BuildSylvesterMatrix_2Polys(fxy_lr, gxy_lr, m, n, k, k1, k2);
        
        % Build Sylvester matrix of polys in preprocessed form
        S3 = BuildSylvesterMatrix_2Polys(fww, alpha.*gww, m, n, k, k1, k2);
        
        % Build Sylvester matrix of polys in preprocessed form with pert.
        S4 = BuildSylvesterMatrix_2Polys(fww_lr, alpha.*gww_lr, m, n, k, k1, k2);
